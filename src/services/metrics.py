        ...
        metrics_dict = {
            ...
            "overall_metrics": {
                "avg_utilization": np.mean(
                    [self.resources[r].avg_utilization for r in self.resources]
                ),
                "max_utilization": max(
                    self.resources[r].max_utilization for r in self.resources
                ),
                "std_dev": np.mean([self.resources[r].std_dev for r in self.resources]),
            },
        }
